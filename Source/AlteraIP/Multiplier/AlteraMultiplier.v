...
//altfp_mult CBX_AUTO_BLACKBOX="ALL" DEDICATED_MULTIPLIER_CIRCUITRY="YES" DENORMAL_SUPPORT="NO" DEVICE_FAMILY="Cyclone V" EXCEPTION_HANDLING="NO" PIPELINE=11 REDUCED_FUNCTIONALITY="NO" ROUNDING="TO_NEAREST" WIDTH_EXP=11 WIDTH_MAN=52 clock dataa datab result
...
module  AlteraMultiplier_altfp_mult_8nn
	( 
	clock,
	dataa,
	datab,
...
endmodule //AlteraMultiplier_altfp_mult_8nn
//VALID FILE
...
module AlteraMultiplier (
	...
	AlteraMultiplier_altfp_mult_8nn	AlteraMultiplier_altfp_mult_8nn_component (
				.clock (clock),
				.dataa (dataa),
				.datab (datab),
				.result (sub_wire0));
