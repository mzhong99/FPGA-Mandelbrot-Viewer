...
//altfp_convert DEVICE_FAMILY="Cyclone V" OPERATION="INT2FLOAT" ROUNDING="TO_NEAREST" WIDTH_DATA=32 WIDTH_EXP_INPUT=8 WIDTH_EXP_OUTPUT=11 WIDTH_INT=32 WIDTH_MAN_INPUT=23 WIDTH_MAN_OUTPUT=52 WIDTH_RESULT=64 clock dataa result
...
module  AlteraIntToDoubleConverter_altbarrel_shift
	( 
	aclr,
	clk_en,
	clock,
...
endmodule //AlteraIntToDoubleConverter_altbarrel_shift
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  AlteraIntToDoubleConverter_altpriority_encoder1234
	( 
	data,
	...
	assign
		q = {data[1]};
endmodule //AlteraIntToDoubleConverter_altpriority_encoder1234
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  AlteraIntToDoubleConverter_altpriority_encoder12345
	( 
	data,
	q,
	...
	assign
		q = {data[1]},
		zero = (~ (data[0] | data[1]));
endmodule //AlteraIntToDoubleConverter_altpriority_encoder12345

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  AlteraIntToDoubleConverter_altpriority_encoder123
	( 
	data,
	q) /* synthesis synthesis_clearbox=1 */;
	input   [3:0]  data;
	...
	AlteraIntToDoubleConverter_altpriority_encoder1234   altpriority_encoder12
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder12_q));
	AlteraIntToDoubleConverter_altpriority_encoder12345   altpriority_encoder13
	( 
	.data(data[3:2]),
...
endmodule //AlteraIntToDoubleConverter_altpriority_encoder123
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  AlteraIntToDoubleConverter_altpriority_encoder123456
	( 
	data,
	q,
	zero) /* synthesis synthesis_clearbox=1 */;
	...
	AlteraIntToDoubleConverter_altpriority_encoder12345   altpriority_encoder14
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder14_q),
	.zero(wire_altpriority_encoder14_zero));
	AlteraIntToDoubleConverter_altpriority_encoder12345   altpriority_encoder15
	( 
	.data(data[3:2]),
...
endmodule //AlteraIntToDoubleConverter_altpriority_encoder123456

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  AlteraIntToDoubleConverter_altpriority_encoder12
	( 
	data,
	q) /* synthesis synthesis_clearbox=1 */;
	input   [7:0]  data;
	...
	AlteraIntToDoubleConverter_altpriority_encoder123   altpriority_encoder10
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder10_q));
	AlteraIntToDoubleConverter_altpriority_encoder123456   altpriority_encoder11
	( 
	.data(data[7:4]),
...
endmodule //AlteraIntToDoubleConverter_altpriority_encoder12
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  AlteraIntToDoubleConverter_altpriority_encoder1234567
	( 
	data,
	q,
	zero) /* synthesis synthesis_clearbox=1 */;
	...
	AlteraIntToDoubleConverter_altpriority_encoder123456   altpriority_encoder16
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder16_q),
	.zero(wire_altpriority_encoder16_zero));
	AlteraIntToDoubleConverter_altpriority_encoder123456   altpriority_encoder17
	( 
	.data(data[7:4]),
...
endmodule //AlteraIntToDoubleConverter_altpriority_encoder1234567

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  AlteraIntToDoubleConverter_altpriority_encoder1
	( 
	data,
	q) /* synthesis synthesis_clearbox=1 */;
	input   [15:0]  data;
	...
	AlteraIntToDoubleConverter_altpriority_encoder12   altpriority_encoder8
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder8_q));
	AlteraIntToDoubleConverter_altpriority_encoder1234567   altpriority_encoder9
	( 
	.data(data[15:8]),
...
endmodule //AlteraIntToDoubleConverter_altpriority_encoder1
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  AlteraIntToDoubleConverter_altpriority_encoder12345678
	( 
	data,
	q,
	zero) /* synthesis synthesis_clearbox=1 */;
	...
	AlteraIntToDoubleConverter_altpriority_encoder1234567   altpriority_encoder18
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder18_q),
	.zero(wire_altpriority_encoder18_zero));
	AlteraIntToDoubleConverter_altpriority_encoder1234567   altpriority_encoder19
	( 
	.data(data[15:8]),
...
endmodule //AlteraIntToDoubleConverter_altpriority_encoder12345678

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  AlteraIntToDoubleConverter_altpriority_encoder
	( 
	data,
	q) /* synthesis synthesis_clearbox=1 */;
	input   [31:0]  data;
	...
	AlteraIntToDoubleConverter_altpriority_encoder1   altpriority_encoder6
	( 
	.data(data[15:0]),
	.q(wire_altpriority_encoder6_q));
	AlteraIntToDoubleConverter_altpriority_encoder12345678   altpriority_encoder7
	( 
	.data(data[31:16]),
...
endmodule //AlteraIntToDoubleConverter_altpriority_encoder
...
//synthesis_resources = lut 53 reg 290 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  AlteraIntToDoubleConverter_altfp_convert
	( 
	clock,
	dataa,
	result) /* synthesis synthesis_clearbox=1 */;
	...
	wire	[10:0]	wire_add_sub3_dataa;
	wire	[10:0]	wire_add_sub3_datab;
	wire	[10:0]	wire_add_sub3_result;
	reg	wire_cmpr4_alb_int;
	wire	wire_cmpr4_alb;
	wire	[10:0]	wire_cmpr4_dataa;
	wire	[10:0]	wire_cmpr4_datab;
	wire aclr;
	...
	AlteraIntToDoubleConverter_altbarrel_shift   altbarrel_shift5
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	AlteraIntToDoubleConverter_altpriority_encoder   altpriority_encoder2
	( 
	.data(prio_mag_int_a),
...
endmodule //AlteraIntToDoubleConverter_altfp_convert
//VALID FILE
...
module AlteraIntToDoubleConverter (
	...
	AlteraIntToDoubleConverter_altfp_convert	AlteraIntToDoubleConverter_altfp_convert_component (
				.clock (clock),
				.dataa (dataa),
				.result (sub_wire0));
